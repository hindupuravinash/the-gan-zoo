...
* MTGAN - [MTGAN: Speaker Verification through Multitasking Triplet Generative Adversarial Networks](https://arxiv.org/abs/1803.09059) ([github](None))
...
* Text2Shape - [Text2Shape: Generating Shapes from Natural Language by Learning Joint Embeddings](-) ([github](None))
